...
export default function Home() {
  ...
  const adVideoUrl = settings?.adVideoUrl || 'https://assets.mixkit.co/videos/preview/mixkit-glowing-led-strip-on-a-desk-42171-large.mp4';
  ...
  return (
    <div className="home-page-root">
      ...
      {/* SEAMLESS RUNNING AD VIDEO BANNER (NO HEADING, NO TEXT, ALL EDGES FADED) */}
      <section className="exact-ad-video-section">
        <div className="exact-ad-video-container">
          <video
            src={adVideoUrl}
            autoPlay
            muted
            loop
            playsInline
            className="exact-ad-running-video"
          />
          {/* Seamless Edge Dissolve Mask on All 4 Sides */}
          <div className="exact-ad-video-edge-fade" />
        </div>
      </section>
